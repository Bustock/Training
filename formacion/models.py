...
class polivalencia(models.Model):
    ...
    TRESA_BLOQUE_1 = models.IntegerField(default=0)
    TRESA_BLOQUE_2 = models.IntegerField(default=0)
    TRESA_BLOQUE_3 = models.IntegerField(default=0)
    ...
    BULK = models.IntegerField(default=0)
